...
// Products
const ListProduct = React.lazy(() => import('./views/products/list-product'))
const ProductForm = React.lazy(() => import('./views/products/product-form')) 
const EditProduct = React.lazy(() => import('./views/products/edit-product-form'))
const ViewProduct = React.lazy(() => import('./views/products/view-product'))
// Recipes
const ListRecipe = React.lazy(() => import('./views/recipes/list-recipe'))
const RecipeForm = React.lazy(() => import('./views/recipes/recipe-form'))
const EditRecipe = React.lazy(() => import('./views/recipes/edit-recipe'))
const ViewRecipe = React.lazy(() => import('./views/recipes/view-recipe'))
// Business
const BusinessProfile = React.lazy(() => import('./views/business/business-profile'))
...
export const routes = [
  ...
  { path: '/products', name: 'Products', element: ListProduct },
  { path: '/products/new', name: 'New Product', element: ProductForm },
  { path: '/products/edit/:id', name: 'Edit Product', element: EditProduct },
  { path: '/products/view/:id', name: 'View Product', element: ViewProduct },
  { path: '/recipes', name: 'Recipes', element: ListRecipe },
  { path: '/recipes/new', name: 'New Recipe', element: RecipeForm },
  { path: '/recipes/edit/:id', name: 'Edit Recipe', element: RecipeForm },
  { path: '/recipes/view/:id', name: 'View Recipe', element: ViewRecipe },
  { path: '/business', name: 'Business', element: BusinessProfile },
  { path: '/dashboard', name: 'Dashboard', element: Dashboard },
